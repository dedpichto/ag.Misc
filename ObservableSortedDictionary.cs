...
namespace ShayCommon.Helpers
{
        ...
        INotifyPropertyChanged
    {
        ...
        #region ctor
        public ObservableSortedDictionary() => _dictionary = [];
        public ObservableSortedDictionary(IComparer<TKey> comparer) => _dictionary = new SortedList<TKey, TValue>(comparer); 
        #endregion
